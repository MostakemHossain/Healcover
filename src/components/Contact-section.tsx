...
const ContactSection = () => {
  ...
  return (
    <section className="py-16 px-4 bg-gray-50 mb-32">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 items-center justify-between lg:grid-cols-2 gap-12 lg:gap-20">
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight">
              We offer guidance to help you make{" "}
              <span className="bg-yellow-200 px-2 py-1 rounded">the right decisions</span>.
            </h2>

            <p className="text-gray-600 mb-8 leading-relaxed">
              Most of us know our driving record affects our car insurance rates. But do you know that your region and even your neighborhood impacts it?
            </p>
            ...
            <div className="flex items-start gap-4 shadow-md p-2 rounded-md">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  <a href="healcare324@gmail.com" className="hover:text-teal-600">
                    healcare324@gmail.com
                  </a>
                </p>
                <p className="text-gray-600">
                  <a href="healcare325@gmail.com" className="hover:text-teal-600">
